...
},{}],"scripts/utils/pasteSvg.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = pasteSVG;
...
function pasteSVG() {
  (0, _jquery.default)("img.svg").each(function () {
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"scripts/utils/theme.js":[function(require,module,exports) {
"use strict";
...
function theme() {
  ...
  (0, _jquery.default)(".switch input").on('change', toggleTheme);
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/vanilla-hamburger/lib/utils/dom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setStyles = exports.getStyles = exports.createRoot = exports.createTemplate = exports.bar = void 0;
...
},{}],"../node_modules/vanilla-hamburger/lib/internals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.update = exports.styles = exports.render = exports.props = void 0;
...
},{}],"../node_modules/vanilla-hamburger/lib/styles/burger.js":[function(require,module,exports) {
"use strict";
...
var _default = `:host{display:block;position:relative;width:48px;height:48px;cursor:pointer;-webkit-user-select:none;user-select:none}:host([hidden]){display:none !important}:host([disabled]){opacity:.5}button{position:absolute;top:0;left:0;width:100%;height:100%;border:none;-webkit-appearance:none;background:transparent;color:inherit}[part=bar]{background:currentColor;position:absolute}`;
exports.default = _default;
},{}],"../node_modules/vanilla-hamburger/lib/components/burger.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Burger = exports.defaultProps = void 0;

var _dom = require("../utils/dom.js");

var _internals = require("../internals.js");

var _burger = _interopRequireDefault(require("../styles/burger.js"));
...
const AREA = 48;
const tpl = (0, _dom.createTemplate)(`<style>${_burger.default}</style>`);
...
class Burger extends HTMLElement {
  ...
  get easing() {
    return this[_internals.props].easing;
  }

  set easing(easing) {
    this[_internals.props].easing = easing;
  ...
  get distance() {
    return this[_internals.props].distance;
  }

  set distance(distance) {
    this[_internals.props].distance = distance;
  ...
  get duration() {
    return this[_internals.props].duration;
  }

  set duration(duration) {
    this[_internals.props].duration = duration;
  ...
  get disabled() {
    return this[_internals.props].disabled;
  }

  set disabled(disabled) {
    this[_internals.props].disabled = disabled;
  ...
  get label() {
    return this[_internals.props].label;
  }

  set label(label) {
    this[_internals.props].label = label;
  ...
  get pressed() {
    return this[_internals.props].pressed;
  }

  set pressed(pressed) {
    this[_internals.props].pressed = pressed;
  ...
  get size() {
    return this[_internals.props].size;
  }

  set size(size) {
    this[_internals.props].size = size;
  ...
  async [_internals.update]() {
    if (!this[updating]) {
      this[updating] = true; // Ensure that property changes are batched.

      this[updating] = await false;

      this[_internals.render](this[prepare]());
    }
  }
...
},{"../utils/dom.js":"../node_modules/vanilla-hamburger/lib/utils/dom.js","../internals.js":"../node_modules/vanilla-hamburger/lib/internals.js","../styles/burger.js":"../node_modules/vanilla-hamburger/lib/styles/burger.js"}],"../node_modules/vanilla-hamburger/lib/components/direction-burger.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DirectionBurger = void 0;

var _burger = require("./burger.js");

var _internals = require("../internals");

class DirectionBurger extends _burger.Burger {
  static get observedAttributes() {
...
exports.DirectionBurger = DirectionBurger;
},{"./burger.js":"../node_modules/vanilla-hamburger/lib/components/burger.js","../internals":"../node_modules/vanilla-hamburger/lib/internals.js"}],"../node_modules/vanilla-hamburger/lib/entrypoints/twirl.js":[function(require,module,exports) {
"use strict";
...
var _directionBurger = require("../components/direction-burger.js");

var _dom = require("../utils/dom.js");

var _internals = require("../internals.js");

const tpl = (0, _dom.createTemplate)(`<button part="button" type="button"></button><div>${_dom.bar}</div><div>${_dom.bar}</div><div>${_dom.bar}</div>`);

class Twirl extends _directionBurger.DirectionBurger {
  constructor() {
    super();
    this[_internals.styles] = (0, _dom.getStyles)((0, _dom.createRoot)(this, tpl));
  }
  ...
  [_internals.render](options) {
    ...
    (0, _dom.setStyles)(this.style, {
      transition: `${time}s ${this.easing}`,
      transform: `${pressed ? `rotate(${90 * (isLeft ? -1 : 1)}deg)` : 'none'}`
    });
    (0, _dom.setStyles)(this[_internals.styles][0], {
      transition: wrapTransition,
      transform: `${pressed ? `translateY(${barHeight + margin}px)` : 'none'}`
    });
    (0, _dom.setStyles)(this[_internals.styles][1], { ...barStyles,
      top: `${topOffset}px`,
      transition: barTransition,
      transform: `${pressed ? `rotate(${45 * (isLeft ? 1 : -1)}deg)` : 'none'}`
    });
    (0, _dom.setStyles)(this[_internals.styles][2], {
      transition,
      opacity: `${pressed ? '0' : '1'}`
    });
    (0, _dom.setStyles)(this[_internals.styles][3], { ...barStyles,
      top: `${topOffset + barHeight + margin}px`,
      transition
    });
    (0, _dom.setStyles)(this[_internals.styles][4], {
      transition: wrapTransition,
      transform: `${pressed ? `translateY(-${barHeight + margin}px)` : 'none'}`
    });
    (0, _dom.setStyles)(this[_internals.styles][5], { ...barStyles,
...
exports.Twirl = Twirl;
},{"../components/direction-burger.js":"../node_modules/vanilla-hamburger/lib/components/direction-burger.js","../utils/dom.js":"../node_modules/vanilla-hamburger/lib/utils/dom.js","../internals.js":"../node_modules/vanilla-hamburger/lib/internals.js"}],"../node_modules/vanilla-hamburger/twirl-burger.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TwirlBurger = void 0;

var _twirl = require("./lib/entrypoints/twirl.js");
 ...
 */
class TwirlBurger extends _twirl.Twirl {}

exports.TwirlBurger = TwirlBurger;
customElements.define('twirl-burger', TwirlBurger);
},{"./lib/entrypoints/twirl.js":"../node_modules/vanilla-hamburger/lib/entrypoints/twirl.js"}],"scripts/utils/menu.js":[function(require,module,exports) {
"use strict";
...
require("vanilla-hamburger/twirl-burger.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function menu() {
  (0, _jquery.default)('twirl-burger').on('click', function () {
    if ((0, _jquery.default)(".header__nav").hasClass("show")) {
      (0, _jquery.default)(".header__nav").removeClass("show");
      document.querySelector("body").removeEventListener("click", closeOnclickPass);
    } else {
      (0, _jquery.default)(".header__nav").addClass("show");
      setTimeout(function () {
  ...
  function closeOnclickPass(e) {
    ...
    if (!nav.contains(e.target)) {
      (0, _jquery.default)('twirl-burger').click();
    }
  }

  function fixHeader() {
    if (window.pageYOffset > (0, _jquery.default)('header').outerHeight()) {
      (0, _jquery.default)('header').addClass("fixed");
    } else {
      (0, _jquery.default)('header').removeClass("fixed");
    }
  }

  window.addEventListener("scroll", fixHeader);
}
},{"jquery":"../node_modules/jquery/dist/jquery.js","vanilla-hamburger/twirl-burger.js":"../node_modules/vanilla-hamburger/twirl-burger.js"}],"../node_modules/ssr-window/ssr-window.esm.js":[function(require,module,exports) {
"use strict";
...
var _html = _interopRequireDefault(require("../../images/web_logotypes/html.png"));

var _css = _interopRequireDefault(require("../../images/web_logotypes/css.png"));

var _js = _interopRequireDefault(require("../../images/web_logotypes/js.png"));

var _fe = _interopRequireDefault(require("../../images/web_logotypes/fe.png"));
...
_swiper.default.use([_swiper.Autoplay, _swiper.Navigation, _swiper.Pagination]);

function sliders() {
  var packages = new _swiper.default(".packages", {
    slidesPerView: 2,
    spaceBetween: 15,
    loop: false,
    navigation: {
    ...
    on: {
      slideChange: function slideChange() {
        switch (packages.realIndex + 2) {
          ...
          default:
            var arrows = document.querySelectorAll(".packages__arrow");
  ...
  var technoSlider = new _swiper.default('.techno__slider .swiper-container', {
    slidesPerView: 1,
    autoplay: {
      delay: 10000
    },
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        switch (index) {
          case 0:
            return "<div class=\"".concat(className, "\"><img src=\"").concat(_html.default, "\", alt=\"").concat(_html.default, "\"></div>");

          case 1:
            return "<div class=\"".concat(className, "\"><img src=\"").concat(_css.default, "\", alt=\"").concat(_html.default, "\"></div>");

          case 2:
            return "<div class=\"".concat(className, "\"><img src=\"").concat(_js.default, "\", alt=\"").concat(_html.default, "\"></div>");

          case 3:
            return "<div class=\"".concat(className, "\"><img src=\"").concat(_fe.default, "\", alt=\"").concat(_html.default, "\"></div>");
    ...
    on: {
      slideChange: function slideChange() {
        var filler = document.querySelector('.techno__filler');
        var bonus = 0;
        var idx = technoSlider.realIndex;
        ...
        filler.style.height = "".concat(idx * 100 + idx * 40 + bonus, "px");
      }
    }
  });
}
},{"swiper":"../node_modules/swiper/swiper.esm.js","../../images/web_logotypes/html.png":"images/web_logotypes/html.png","../../images/web_logotypes/css.png":"images/web_logotypes/css.png","../../images/web_logotypes/js.png":"images/web_logotypes/js.png","../../images/web_logotypes/fe.png":"images/web_logotypes/fe.png"}],"scripts/main.js":[function(require,module,exports) {
"use strict";
...
var _pasteSvg = _interopRequireDefault(require("./utils/pasteSvg"));

var _theme = require("./utils/theme");

var _menu = require("./utils/menu");

var _sliders = require("./utils/sliders");
...
(0, _jquery.default)(document).ready(function () {
  (0, _pasteSvg.default)();
  (0, _sliders.sliders)(); // window.onscroll = () => { scrollProgress() };
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","wow.js":"../node_modules/wow.js/dist/wow.js","./utils/pasteSvg":"scripts/utils/pasteSvg.js","./utils/theme":"scripts/utils/theme.js","./utils/menu":"scripts/utils/menu.js","./utils/sliders":"scripts/utils/sliders.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
